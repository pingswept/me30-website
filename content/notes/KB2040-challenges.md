...
2. Make your KB2040 send the text, "I, for one, welcome our new insect overlords." to your serial monitor once per second.***
3. Use a 10k resistor to pull pin D5 high or low. Print out the pin's state as "HIGH" or "LOW" on the serial monitor every time it changes.
...
9. Use you potentiometer on pin A0 to control the speed of your gearmotor on pin D6.
10. Challenge TBD with photoresistor.
