...
This video demonstrates prototyping a simple LED circuit, powered by laptop power routed through an Arduino's Vcc output pin. Your Feather RP2040 3.3V output pin is similar to the Arduino Vcc output pin.
