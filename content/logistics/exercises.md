...
## 4. Build voltage dividers (Class 2)
...
## 5: Build a voltage regulation circuit (Class 2 and 3)
...
## 7: Review of voltage and current (Class 3 and 4)
...
## 8. Control a motor with a BJT (Class 7)
...
## 9. Determine pin voltages and ideal resistor value for a BJT circuit (Class 7 and 8)
...
## 10. Control a motor with a MOSFET (Class 8)
...
## 11. De-bugging challenges set 1 (Class 10)
...
## 12. KB2040 microcontroller challenges set 1 (Class 10 and labs)
...
## 13. Project 2 takeaways reflection (Class 11)
...
## 14. Mechanically controlled two-way motor circuit (Class 11)
...
## 16. H-bridge circuit analysis  (Class 12)
...
## 17. H-bridge circuit analysis, part 2 (Class 13)
...
## 18a. Measure a DC gearmotor (Power In) (Class 13)
...
## 18b. Measure a DC gearmotor (Power Out) (Class 14)
...
## 20. Motor speed-torque curve (Class 15)
...
## 21. Motor selection cases (Class 15)
...
## 22. Analog and digital sensors (Class 16)
...
## 23. More practice with sensors and PWM (Class 16)
...
## 24. How to code your microcontroller to constantly check an input while also running actuators (Class 16)
...
## 25. Using a state machine with a motor (Class 17)
...
## 26. Using a state machine with two inputs (Class 17)
...
## 27. Stepper motor set-up (Class 17)
...
## 28. More sensors and actuators (Class 17)
...
## 32. Oscilloscopes and PWM signals (Class 23)
...
## 32. ME 30 career connections and Project 6 planning (Class 26)
